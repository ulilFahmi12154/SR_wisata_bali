            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        ...
                        <tbody class="divide-y divide-slate-50 text-xs">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 flex items-center gap-4">
                                    ...
                                    <div class="min-w-0">
                                        {{-- PERBAIKAN: Mengubah $row menjadi $destination --}}
                                        <h4 class="font-bold text-slate-800 text-sm truncate">{{ $destination->nama }}</h4>
                                        <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">ID: DEST-0{{ $destination->id }}</p>
                                    </div>
                                </td>
                            ...
                            @empty
                            <tr>
                                {{-- PERBAIKAN: Memastikan colspan berjumlah 5 sesuai total header kolom --}}
                ...
                <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/30 flex items-center justify-between">
                    <div class="text-xs text-slate-500">
                        Menampilkan {{ $destinations->firstItem() }} sampai {{ $destinations->lastItem() }} dari {{ $destinations->total() }} destinasi
                    </div>
