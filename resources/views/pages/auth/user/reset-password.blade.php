            ...
            <div class="relative">
                ...
                <input
                    ...
                    class="h-12 w-full rounded-2xl border pl-11 pr-4 text-sm text-slate-800 shadow-sm shadow-slate-200/40 transition-all duration-200 placeholder:text-slate-400 focus:outline-none focus:ring-4
                           ...
                           @else
                               border-slate-200 {{ $emailReadonly ? 'bg-slate-100/70 text-slate-600' : 'bg-slate-50/70' }} focus:border-sky-400 focus:bg-white focus:ring-sky-100
                           @enderror"
                >
            </div>
        ...
        >
            ...
            <div class="relative">
                ...
                <input
                    ...
                    oninvalid="const label = this.getAttribute('data-label') || 'Password Baru'; let message = ''; if (this.validity.valueMissing) { message = label + ' wajib diisi.'; } else if (this.validity.tooShort) { message = label + ' minimal ' + this.minLength + ' karakter.'; } this.setCustomValidity(message);"
                    oninput="this.setCustomValidity('');"
